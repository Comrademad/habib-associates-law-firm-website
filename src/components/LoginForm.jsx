      ...
      >
        <div className="max-w-md mx-auto bg-green-50 border border-green-200 rounded-lg p-6">
          ...
          <p className="text-sm text-green-600">
            You can now edit content and manage lawyers throughout the site.
          </p>
        </div>
      </motion.div>
    )
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md shadow-sm bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200"
